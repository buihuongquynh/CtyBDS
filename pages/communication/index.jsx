      ...
      <div className="map homeBannerBottom">
        <div className="img">
          <h2 className="view_map">
            {" "}
            <a href="https://www.google.com/maps?q=74+Th%C3%B4i+H%E1%BB%AFu,+P.+Ng%E1%BB%8Dc+Tr%E1%BA%A1o,+Th%C3%A0nh+ph%E1%BB%91+Thanh+H%C3%B3a,+Thanh+Ho%C3%A1&ftid=0x3136f808813537d1:0x6db47eb2ede288b2&hl=vi-VN&gl=vn&entry=gps&lucs=s2se,a1&shorturl=1">
              Xem bản đồ{" "}
            </a>
          </h2>
